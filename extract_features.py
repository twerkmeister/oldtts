...
if __name__ == "__main__":
    ...
    parser.add_argument('--cache_path', type=str,
                        help='Cache folder, place to output all the '
                             'spectrogram files.')
    parser.add_argument(
    ...
    parser.add_argument("--only_mel", type=bool, default=False,
                        help="If True, only melsceptrogram is extracted.")
    parser.add_argument("--dataset", type=str,
                        help="Target dataset to be processed.")
    ...
    parser.add_argument("--process_audio", type=bool, default=False,
